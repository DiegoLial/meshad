...
const en = {
  ...
  'demo.devBanner': 'DEV MODE — HYPOTHETICAL example ads, unlimited; nothing sent, nothing billed (meshad config dev_mode false to leave)',
  'demo.hypBanner': 'HYPOTHETICAL SHOWCASE — looping {n} bundled example ad(s) forever (Ctrl+C stops; nothing sent, billed or credited)',
  'demo.allBanner': 'SHOWCASE — playing all {n} ad(s) in the current pack (preview: nothing sent, billed or credited)',
  'demo.allDone': 'showcase over — {n} ad(s) shown. A real wait rotates through these automatically.',
...
const ptBR = {
  ...
  'demo.devBanner': 'MODO DEV — anúncios-exemplo HIPOTÉTICOS, ilimitados; nada é enviado, nada é faturado (meshad config dev_mode false para sair)',
  'demo.hypBanner': 'VITRINE HIPOTÉTICA — {n} anúncio(s)-exemplo embutidos em loop infinito (Ctrl+C para sair; nada é enviado, faturado ou creditado)',
  'demo.allBanner': 'VITRINE — exibindo todos os {n} anúncio(s) do pack atual (prévia: nada é enviado, faturado ou creditado)',
  'demo.allDone': 'fim da vitrine — {n} anúncio(s) exibidos. Numa espera real, eles rotacionam sozinhos.',
